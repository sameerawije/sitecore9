            ...
            var extensionObject = {
                ...
                initializeDialogs: function() {
                        ...
                        function() {
                            var dialogParams = {
                                callback: function(item, itemId) {
                                    current
                                        .addSourceCallback(item,
                                            itemId,
                                            current.contactListPagePattern.replace("?id=", ""));
                                },
                            ...
                            var dialogParams = {
                                callback: function(item, itemId) {
                                    current
                                        .addSourceCallback(item,
                                            itemId,
                                            current.segmentedListPagePattern.replace("?id=", ""));
                                },
                                filter: "getContactLists"
                            };
                            current.Dialogs.showDialog(current.Dialogs.Ids.SelectListDialog, dialogParams);
                    ...
                    sitecore.on("import:new:contacts:dialog:create:list:from:file",
                        function() {
                            current.Dialogs.showDialog(current.Dialogs.Ids.ImportDialog,
