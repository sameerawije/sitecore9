    ...
    function(sitecore, backbone) {
        ...
        var Condition = backbone.LayoutManager.extend({
            ...
            initialize: function(options) {
                ...
                var self = this;
                self.model.on("change:isOpen",
                    function() { self.trigger((self.model.get("isOpen") ? "open" : "close") + ":" + self.cid); },
                    self);
            ...
            afterRender: function() {
                ...
                Array.prototype.filter.call(self.parent.segmentBuilderFrameContainer.jQuery
                    .find("#" + ruleId + "_body"),
                    function(ruleBodyElement) {
                        self.ruleChanged(ruleId, triggerChange);
                        $(ruleBodyElement).on('DOMNodeInserted DOMNodeRemoved DOMSubtreeModified',
                            function(event) {
            ...
            deleteItem: function() {
                ...
                self.parent.segmentBuilderFrameContainer.scForm
                    .postEvent(null,
                        theEvent,
                        'javascript:Sitecore.CollapsiblePanel.remove(this, event, \"' +
                        self.model.get("conditionId") +
                        '\")');
                var ruleId = self.model.get("conditionId");
                self.ruleChanged(ruleId, true);
                return self;
            ...
            editRules: function() {
                ...
                var theEvent = new Object();
                self.parent.segmentBuilderFrameContainer.scForm
                    .postEvent(null, theEvent, 'EditFilterConditionClick(\"' + self.model.get("conditionId") + '\")');
            },
            ruleChanged: function(ruleId, fireChangeTrigger) {
                ...
                if (conditionsmatchContainer) {
                    Array.prototype.filter.call(self.parent.segmentBuilderFrameContainer.jQuery
                        .find("#" + ruleId + "_body"),
                        function(ruleBodyElement) {
                            Array.prototype.filter.call($(ruleBodyElement).find(".right-column"),
        ...
        sitecore.Factories.createBaseComponent({
            ...
            initialize: function() {
                ...
                self.segmentBuilderUrl = self.$el.data("sc-segmentbuilderurl")
                    ? self.$el.data("sc-segmentbuilderurl")
                    : null;
                ...
                if (iFrame) {
                    ...
                    iFrame.load(function() {
                        ...
                        if (self.segmentBuilderFrameContainer) {
                            /* Fix for supporting old JQuery version before JQuery 1.10.2*/
                            if (isIe11) {
                                if (typeof self.segmentBuilderFrameContainer.attachEvent == "undefined" &&
                                    !self.segmentBuilderFrameContainer.attachEvent) {
                                    self.segmentBuilderFrameContainer.attachEvent = self.segmentBuilderFrameContainer
                                        .addEventListener;
                                }
                            }
                            Array.prototype.filter.call(self.segmentBuilderFrameContainer.jQuery
                                .find(self.ruleContainerSelector),
                                function(existingCondition) {
            ...
            addNewCondition: function() {
                ...
                if (self.segmentBuilderFrameContainer) {
                    ...
                    var addedCondition = self.segmentBuilderFrameContainer.jQuery.find(self.ruleContainerSelector)
                        .last();
                    if (addedCondition) {
            ...
            getRulesXML: function() {
                ...
                if (self.segmentBuilderFrameContainer) {
                    Array.prototype.filter.call(self.segmentBuilderFrameContainer.jQuery.find("#RulesXml"),
                        function(rulesXmlElement) {
                            if (rulesXmlElement) {
            ...
            setRulesXML: function(value) {
                var self = this;
                value = value.replace(/"/g, "'");
                var load = function(rulesXml) {
                    var theEvent = new Object();
                    self.segmentBuilderFrameContainer.scForm
                        .postEvent(null, theEvent, 'Initialize("' + rulesXml + '")');
                    Array.prototype.filter.call(self.segmentBuilderFrameContainer.jQuery
                        .find(self.ruleContainerSelector),
                        function(existingCondition) {
                            self.insertCondition(existingCondition, false);
                ...
                if (self.segmentBuilderFrameContainer) {
                    ...
                    $("#SegmentBuilderFrame").load(function() {
                        load(value);
                    });
                }
            }
