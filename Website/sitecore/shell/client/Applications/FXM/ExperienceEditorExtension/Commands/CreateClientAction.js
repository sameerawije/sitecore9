define([
    ...
    function(_sc, _legacy, $sc, ExperienceEditor, TranslationUtil) {
        var pagePath = "/sitecore/client/Applications/FXM/ExperienceEditorExtension/Dialogs/CaptureClientAction";
        _sc.Commands.CreateClientAction =
        {
            canExecute: function(context) {
                // Review: validate is allowed
                return true;
            },
            execute: function(context) {
                ...
                ExperienceEditor.Dialogs.showModalDialog(dialogPath,
                    null,
                    dialogFeatures,
                    null,
                    function(data) {
                        if (context.callback) {
                            ...
                            if (data != null) {
                                ...
                                var message = TranslationUtil
                                    .translateTextByServer("The FXM function you have placed on this page has been saved.",
                                        ExperienceEditor);
                                var actionMessage = "";
                                var actionClick = "";
