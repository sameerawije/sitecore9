        ...
        var RibbonPageCode = Sitecore.Definitions.App.extend({
            initialized: function () {
                ...
                this.currentContext = {
                    ...
                    lockedItemsCount: this.PageEditBar.get("lockedItemsCount"),
            ...
            initializeRibbon: function () {
                ...
                require(ribbonModules, function () {
                    var pipelineContext = ExperienceEditor.Common.cloneObject(self.currentContext);
                    ExperienceEditor.PipelinesUtil.initPipeline(self.InitializePageEditPipeline, function () {
            ...
            initializeNotifications: function (context) {
                ...
                if (isEditMode) {
                    this.NotificationBar.viewModel.$el.on("click", "button.close", function (e) {
            ...
            showEditModeNotifications: function (context) {
                ...
                ExperienceEditor.PipelinesUtil.generateRequestProcessor("ExperienceEditor.Item.Notifications", function (response) {
                    ...
                    for (var i = 0; i < notifications.length; i++) {
                        ...
                        var notificationElement = this.showNotification(notificationTypes[notification.Type], notification.Description, true);
            ...
            publishAffectedPagesNotification: function (context) {
                console.warn("Obsolete. This function is no longer supported use ShowDataSources.publishAffectedPagesNotification(context) instead");
                Sitecore.Commands.ShowDataSources.publishAffectedPagesNotification(context);
            },

            //[Obsolete]
            showPublishAffectedPagesNotification: function () {
                console.warn("Obsolete. This function is no longer supported use ShowDataSources.showPublishAffectedPagesNotification() instead");
                Sitecore.Commands.ShowDataSources.showPublishAffectedPagesNotification();
            },

            //[Obsolete]
            registerPageEditorNotificationHandler: function () {
                console.warn("Obsolete. This function is no longer supported and will be deleted in the next product version.");
                ExperienceEditor.Common.addOneTimeEvent(function () {
                    return ExperienceEditor.getPageEditingWindow().Sitecore.PageModes.PageEditor;
                }, function (that) {
            ...
            initializeExperienceEditorObject: function (context) {
                ...
                if (hooks.length > 0) {
                    console.warn("Sitecore.ExperienceEditor.Hooks is no longer supported, please register your own client processor (under core/sitecore/client/Applications/ExperienceEditor/Pipelines/InitializePageEdit pipeline) instead");
                }
            ...
            setToggleShow: function () {
                ...
                this.QuickRibbon.viewModel.$el.find("div").attr("class", "sprite-speak-ribbon-clean-ee small navigate_down");
                ...
                var self = this;
                ExperienceEditor.getPageEditingWindow().document.body.addEventListener("click", function (sender) {
            ...
            toggleCollapse: function (denyCollapse, ignoreCookies) {
                ...
                if (this.shown) {
                    this.QuickRibbon.viewModel.$el.find("div").attr("class", "sprite-speak-ribbon-clean-ee small navigate_up");
            ...
            executeCachedCommands: function () {
                ...
                if (this.cachedCommands) {
                    ExperienceEditor.CommandsUtil.runCommandsCollectionCanExecute(this.cachedCommands, function (stripId) {
            ...
            canExecute: function (commandQuery, commandContext) {
                var result = false;
                var that = this;
                ExperienceEditor.Web.postServerRequest(commandQuery, commandContext, function (response) {
            ...
            postServerRequest: function (requestType, commandContext, handler, async) {
                console.warn("Obsolete. This method is no longer supported use   ExperienceEditor.Web.postServerRequest(requestType, commandContext, handler, async) instead");
            ...
            refreshOnItem: function (context, allowParameterRedirection, keepVersion, keepSite) {
                console.warn("Obsolete. This method is no longer supported use ExperienceEditor.CommandsUtil.executeButtonCommand(button) instead");
            ...
            //[Obsolete]
            clone: function (obj) {
                console.warn("This method is obsolete and will be removed in the next product version, please use ExperienceEditor.Common.cloneObject instead.");
                return ExperienceEditor.Common.cloneObject(obj);
            },

            //[Obsolete]
            getButton: function (eventTarget) {
                console.warn("Obsolete. This method is no longer supported use DOMHelper.getButton(eventTarget) instead");
                return DOMHelper.getButton(eventTarget, this);
            },

            //[Obsolete]
            setButtonPressed: function (button) {
                console.warn("Obsolete. This method is no longer supported use DOMHelper.setButtonPressed(button) instead");
                DOMHelper.setButtonPressed(button, this);
            },
            ...
            executeCommand: function (commandName, commandArgument, button) {
                console.log("Obsolete. This method is no longer supported use ExperienceEditor.CommandsUtil.executeCommand(commandName, commandArgument, button) instead");
                ExperienceEditor.CommandsUtil.executeCommand(commandName, commandArgument, button);
            },

            //[Obsolete]
            getCommand: function (commandName) {
                console.warn("Obsolete. This method is no longer supported use ExperienceEditor.CommandsUtil.getCommand(commandName) instead");
                return ExperienceEditor.CommandsUtil.getCommand(commandName);
            },

            //[Obsolete]
            formCommandName: function (commandName) {
                console.warn("Obsolete. This method is no longer supported use ExperienceEditor.CommandsUtil.formCommandName(commandName) instead");
                return ExperienceEditor.CommandsUtil.formCommandName(commandName);
            },

            //[Obsolete]
            getContext: function (button) {
                console.warn("Obsolete. This method is no longer supported use ExperienceEditor.RibbonApp.getAppContext(button) instead");
